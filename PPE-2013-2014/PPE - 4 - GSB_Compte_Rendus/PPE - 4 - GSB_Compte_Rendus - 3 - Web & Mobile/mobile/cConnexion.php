...
<html lang="fr">
        ...
        <form class="form-vertical login-form" action="../config/_post.mobile.connexion.php" method="post">
          ...
          <div class="form-group">
            ...
            <div class="input-icon">
              <i class="icon-user"></i>
              <input type="text" class="form-control" data-rule-required="true" data-msg-required="Entrez votre identifiant." id="txtLogin" name="txtLogin" maxlength="20" size="15" value="" title="Entrez votre identifiant." placeholder="Votre identifiant." autofocus="autofocus"/>
            </div>
          </div>
          <div class="form-group">
  ...
  <?php
    ...
    if(isset($_SESSION['Erreur_Log'])){
    ?>
    <script> alert(" <?php echo $_SESSION['Erreur_Log']; ?> "); </script>
    <?php
    }
  ?>
</html>