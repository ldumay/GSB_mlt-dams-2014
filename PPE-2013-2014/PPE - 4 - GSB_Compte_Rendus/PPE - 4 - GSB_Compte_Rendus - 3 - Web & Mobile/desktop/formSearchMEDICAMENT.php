...
<div id="contenu">
  ...
  <div>
    <form name="formSearchMEDICAMENT" method="post" action="formSearchMEDICAMENT.php">
      <?php
        // =====
        // $req4 = $bdd->query('SELECT * FROM contre_indic ORDER BY ID"');
        // =====
      ?>
      <p>
        Critères de contre indications :<br />
        <input type="checkbox" name="ton_nom" id="ton_nom" /> <label for="ton_nom">Contre indication 1</label><br />
        <input type="checkbox" name="ton_nom" id="ton_nom" /> <label for="ton_nom">Contre indication 2</label><br />
        <input type="checkbox" name="ton_nom" id="ton_nom" /> <label for="ton_nom">Contre indication 3</label><br />
        <input type="checkbox" name="ton_nom" id="ton_nom" /> <label for="ton_nom">Contre indication 4</label>
      </p>
